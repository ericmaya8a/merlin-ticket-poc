...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      classNames={{
        months:
        "flex flex-col lg:!space-x-14 sm:flex-row space-y-4 sm:space-x-4 sm:space-y-0",
        month: "space-y-4",
        ...
        head_cell:
          "text-[#A1A3AA] rounded-md font-bold text-[0.8rem] dark:text-neutral-400",
        row: "flex justify-between w-full mt-2 gap-[14px]",
        cell: cn(
